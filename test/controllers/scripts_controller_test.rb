...
class ScriptsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create script" do
    assert_difference("Script.count") do
      post scripts_url, params: { script: { filename: @script.filename, mypart_id: @script.mypart_id, programminglanguage_id: @script.programminglanguage_id } }
    end
  ...
  test "should update script" do
    patch script_url(@script), params: { script: { filename: @script.filename, mypart_id: @script.mypart_id, programminglanguage_id: @script.programminglanguage_id } }
