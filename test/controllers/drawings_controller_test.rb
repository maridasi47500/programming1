...
class DrawingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create drawing" do
    assert_difference("Drawing.count") do
      post drawings_url, params: { drawing: { image: @drawing.image, mypart_id: @drawing.mypart_id, title: @drawing.title } }
    end
  ...
  test "should update drawing" do
    patch drawing_url(@drawing), params: { drawing: { image: @drawing.image, mypart_id: @drawing.mypart_id, title: @drawing.title } }
